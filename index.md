...
agent home cache — [Runner Context Hygiene](pages/runner-context-hygiene.md), src/prompt.rs
...
generated file context — [Runner Context Hygiene](pages/runner-context-hygiene.md), src/prompt.rs
...
plugin caches — [Runner Context Hygiene](pages/runner-context-hygiene.md), src/prompt.rs
...
src/prompt.rs — [Runner Context Hygiene](pages/runner-context-hygiene.md)
