...
After an agent or reviewer exits, mrmouth may need to persist a
container-edited `.mrmouth/Dockerfile` back to the host checkout so the next run
can rebuild with new tooling.
